...
.dragon .body {
    ...
    width: 180px;
    height: 128px;
    background: url(../../assets/loading/body.png) no-repeat center center;
...
.dragon .horn-left {
    ...
    width: 31px;
    height: 31px;
    background: url(../../assets/loading/horn-left.png) no-repeat;
    background-size: contain;
    z-index: 9;
...
.dragon .horn-right {
    ...
    width: 34px;
    height: 31px;
    background: url(../../assets/loading/horn-right.png) no-repeat;
    background-size: contain;
    z-index: 9;
...
.dragon .eye {
    ...
    width: 11px;
    height: 11px;
    background: url(../../assets//loading/eye.png) no-repeat;
    background-size: contain;
    z-index: 12;
}
...
.dragon .blush {
    ...
    width: 15px;
    height: 9px;
    background: url(../../assets/loading/blush.png) no-repeat;
...
.dragon .mouth {
    ...
    width: 78px;
    height: 56px;
    background: url(../../assets/loading/mouth.png) no-repeat;
    background-size: 100%;
    z-index: 11;
...
.dragon .tail-sting {
    ...
    width: 40px;
    height: 38px;
    background: url(../../assets/loading/tail-sting.png) no-repeat;
    background-size: contain;
    z-index: 9;
...
.fire {
    ...
    width: 100%;
    height: 100%;
    background: url(../../assets/loading/fire.png) no-repeat;
    background-size: contain;
